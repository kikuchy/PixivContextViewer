...
pcv.contextViewer.BackController = (function(){
  ...
  BackController.prototype.saveContext = function(url){
    pcv.contextViewer.localContextStorage(this.tabId, url);
  };

  BackController.prototype._restoreContext = function(tabId){
    var ret = pcv.contextViewer.localContextStorage(tabId);
    pcv.contextViewer.localContextStorage(tabId, null);
    return ret;
  };

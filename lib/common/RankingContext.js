...
pcv.contextViewer.RankingContext = (function($){
  ...
  RankingContext.prototype.getNext = function(){
    var dfd = $.Deferred();
    var self = this;
    $.when(this.getHasNext()).done(function(has){
  ...
  RankingContext.prototype.getPrev = function(){
    var dfd = $.Deferred();
    var self = this;
    $.when(this.getHasPrev()).done(function(has){
      if(!has) dfd.resolve(null);

var PixivContextViewerView = (function(){
  ...
  PixivContextViewerView.prototype.centeringListToHere = function(){
    var wWidth = this.$pcvWindow.width();
    var $here = $("li.pcv-image-item.here");
    var hWidth = $here.width();
    var hPos = $here.offset().left;
